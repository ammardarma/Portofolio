...
george.shape("turtle")
george.speed(5)
#define a function to draw and fill a rectangle with the given dimensions and color 
...
def drawTriangle (t, length, color):
	...
	t.left(135)
	t.end_fill()
def drawParalellogram(t,width,height,color): 
	t.fillcolor(color)
	t.begin_fill()
	t.left(30)
	t.forward(width)
...
george.goto(-50,-120)
george.pendown()
drawParalellogram(george, 60, 110, "yellow")
# Window
george.penup()
george.goto(-30, -60)
george.pendown()
drawParalellogram(george,20,30,"brown")
#side roof 
george.penup()
george.goto(-50, -10)
george.pendown()
